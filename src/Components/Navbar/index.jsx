...
//     return (
//         <>
//             <div className={pathname === "/" ? "lg:bg-contain lg:bg-left  bg-top  bg-cover md:h-[370px] h-[230px] lg:h-[105vh] bg-no-repeat  px-3 relative" : "px-3 bg-cover "} style={pathname === "/" ? {
...
//                             <Link to="/" className='my-1 text-[18px] lg:text[19px]  ' onClick={closeMenuBar}>HOME</Link>
//                             <Link to="/about-us" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>ABOUT US</Link>
//                             <Link to="/services" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>SERVICES</Link>
//                             <Link to="/portfolio" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>PORTFOLIO</Link>
//                             <Link to="/on-going-project-list" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>ON-GOING PROJECTS</Link>
//                             <Link to="/gallery" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>GALLERY</Link>
//                             <Link to="/blogs" className='my-1 text-[18px] lg:text[19px] ' onClick={closeMenuBar}>BLOGS</Link>
//                         </div>
        ...
        <>
            ...
            >
                ...
                <div className="flex justify-between md:items-center lg:items-start px-2 md:pl-4 md:pr-0   2xl:w-[100%] ">
                    ...
                    <img src={logo} alt="" className="z-50 mt-6 xl:ml-[81%]   md:pt-1 lg:mt-0 w-[58px] h-[98px] lg:w-[144px] lg:h-[238px] bg-blend-multiply logo " />
                </div>
