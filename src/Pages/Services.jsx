...
export default function Services() {
  ...
  return (
    <>
      ...
      <div className="  relative bg-no-repeat  lg:bottom-48  md:bottom-1 bottom-5 sm:bottom-5 bg-center bg-contain " style={{
      ...
      <div className="md:flex justify-center items-center w-full md:-mt-28">
        <div data-aos="fade-down"
          ...
          <div className="  flex flex-col md:flex-row gap-4 justify-between mb-50 flex-wrap gap-y-10 text-center">
            <div data-aos="flip-up" class=" pt-8 p-4 md:w-[32%] h-[370px] w-full bg-white border   hover:border-[#C1AE69]  flex flex-col items-center group">
            ...
            <div
              data-aos="flip-up"
              class=" p-4 pt-8 md:w-[32%] w-full bg-white border h-[370px]  hover:border-[#C1AE69]  flex flex-col items-center group">
            ...
            <div
              ...
              class="p-4 pt-8 h-[370px] md:w-[32%] w-full hover:border-[#C1AE69] bg-white border border-gray-200  shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center group">
            ...
            <div
              ...
              data-aos="flip-up"
              class=" p-4 pt-8 md:w-[32%] h-[370px] w-full bg-white border   hover:border-[#C1AE69]  flex flex-col items-center group">
      ...
      <div data-aos="fade-down" className="md:flex justify-center  w-full relative md:bottom-12 -bottom-10 sm:bottom-5  mb-2 md:mb-0">
        <div
          ...
          <div className="flex flex-wrap -mx-4 md:-mx-4 lg:-mx-4 mt-8">
            <div
              data-aos="fade-left"
              className="p-4 pr-0 md:w-[45%] lg:w-[45%]">
            ...
            <div
              ...
              className="p-4 md:pl-0 md:w-[55%] lg:w-[55%]">
      ...
      <div className="bg-contain p-5 pb-16 pt-28 -mb-12" style={{ backgroundImage: ` url(${services_crousal_bg})`, backgroundPosition: "left", backgroundRepeat: "no-repeat", }}>
        <div className="md:flex flex-col justify-start items-center w-[90%] md:w-[80%] m-auto pt-0 " >
