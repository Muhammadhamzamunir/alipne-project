    ...
    <>
      ...
      <div className="bg-contain  relative  lg:bottom-28 md:bottom-1 bottom-5 sm:bottom-5" >
        ...
        {/* <Carousel
          infinite={true}
          autoPlay={true}
          autoPlaySpeed={1000} // Set to a very low value for continuous autoplay
          swipeable={true}
          draggable={true}
          showDots={false}
          arrows={false}
          ...
          transitionDuration={5000} // Adjust this value for smoother movement
      ...
      <div className="md:flex justify-center items-center w-full">
        <div data-aos="fade-down"
          ...
          <div className="  flex flex-col md:flex-row gap-4 justify-between mb-50 flex-wrap gap-y-10 text-center">
            <div data-aos="flip-up" class="p-4 md:w-[32%] w-full bg-white border   hover:border-[#C1AE69]  flex flex-col items-center group">
            ...
            <div
              data-aos="flip-up"
              class=" p-4 md:w-[32%] w-full bg-white border   hover:border-[#C1AE69]  flex flex-col items-center group">
